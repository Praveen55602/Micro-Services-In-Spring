package com.example.empoyeeservice.controller;
...
import com.example.empoyeeservice.repository.EmployeeRepository;
...
public class EmployeeController {
    ...
    public List<Employee> findByDepartment(@PathVariable("departmentId") Long id) {
        LOGGER.info("Employee find id: departmentId= {}", id);
